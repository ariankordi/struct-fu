...
var _buf = entry.pack(obj0);
var obj1 = entry.unpack(_buf);
console.log('', obj0, '\n==>\n', obj1);
//console.log(_buf);
...
var bitzz = _.struct([
    ...
    _.ubitLE('c', 3),
    _.sbit('d', 9)
]); var bufzz = bitzz.pack({ a: true, b: 1, c: 1, d: -2 }); var backzz = bitzz.unpack(bufzz);
...
try {
    ...
    assert(Boolean(threw), 'Invalid padding detected.');
}
...
var dervStruct = _.struct([_.char('header', 8), hexType('bignums', 2), _.bool('footer'), _.bool('pad', 7)]);
...
var derString = _.derive(derInvert(), function (s) { return s === 'true'; }, function (x) { return '' + x; });
...
_storeDataBuffer.forEach(function (buf, i) {
    ...
    var expectedWithoutStrings = /** @type {Object<string, *>} */ (Object.assign({}, expected));
